  ...
  public: {
    ...
    Functions: {
      ...
      admin_update_caderno: {
        Args: { p_caderno_id: string; p_is_public: boolean; p_nome: string }
        Returns: undefined
      }
      ...
      check_table_exists: {
        Args: { in_schema_name?: string; in_table_name: string }
        Returns: boolean
      }
      ...
      update_user_role: {
        Args: { new_nivel: string; new_role: string; user_id: string }
        Returns: undefined
      }
