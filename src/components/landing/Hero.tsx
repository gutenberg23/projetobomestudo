      ...
      <div className="mx-auto px-4 min-h-screen flex flex-col justify-center items-center relative z-20 py-16 bg-white">
        <div className="text-center space-y-6 max-w-3xl px-4">
          <h1 className="text-3xl sm:text-4xl leading-tight md:text-7xl font-thin text-[#272f3c]">
            Conectando <span className="font-extrabold text-[#272f3c]">Alunos</span> e <span className="text-black font-extrabold">Professores</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
            ...
            <Button onClick={() => setTeacherDialogOpen(true)} className="rounded-lg text-sm sm:text-lg tracking-wider transition-all px-8 sm:px-10 py-6 sm:py-7 bg-white border-2 border-[#491aa4] hover:bg-[#ea2be2]/5 hover:shadow-lg hover:shadow-[#ea2be2]/20 hover:-translate-y-1 w-full sm:w-auto font-normal text-[#5f2bc1]">
              QUERO SER PROFESSOR
            </Button>
          </div>
        </div>
