      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
        ...
        <Card className="border shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-4">
            <CardTitle className="text-2xl font-bold text-[#272f3c]">Plano Gratuito</CardTitle>
            <CardDescription className="text-[#67748a]">Acesso aos conteúdos básicos</CardDescription>
          </CardHeader>
          
          <CardContent className="pt-6">
            <div className="flex justify-center items-center mb-8">
              <span className="text-4xl font-bold text-[#272f3c]">R$ 0</span>
          ...
          <CardFooter className="flex justify-center pb-8">
            <Link to="/login" className="w-full">
              <Button className="w-full bg-white text-[#67748a] border border-gray-200 hover:bg-gray-50 text-lg py-6">
                Começar Grátis
              </Button>
            </Link>
          </CardFooter>
