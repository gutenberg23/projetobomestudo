...
export const StudentBenefits = () => {
  return (
    <div className="w-full px-3 sm:px-4 py-14 sm:py-16 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 px-2 sm:px-3 md:px-0">
          {[
            {
              icon: <BookOpen className="w-8 h-8 sm:w-10 sm:h-10 text-[#ea2be2]" />,
            ...
            {
              icon: <FileText className="w-8 h-8 sm:w-10 sm:h-10 text-[#ea2be2]" />,
              title: "Edital Verticalizado",
              description: "Organize seu estudo seguindo a estrutura do edital do seu concurso para uma preparação eficiente"
            },
            {
              icon: <Award className="w-8 h-8 sm:w-10 sm:h-10 text-[#ea2be2]" />,
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#272f3c] mb-2 sm:mb-3">
                  {benefit.title}
                </h3>
                <p className="text-sm sm:text-base text-[#67748a] flex-grow">
                  {benefit.description}
                </p>
              </div>
            </div>
