      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl text-[#272f3c] mb-3 sm:mb-4 font-extrabold">
            Por que estudar no <span className="text-[#5f2ebe]">BomEstudo</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {[{
          icon: <BookOpen className="w-8 h-8 sm:w-10 sm:h-10 text-[#5f2ebe]" />,
          ...
          icon: <FileText className="w-8 h-8 sm:w-10 sm:h-10 text-[#5f2ebe]" />,
          title: "Edital Verticalizado",
          description: "Organize seu estudo seguindo a estrutura do edital do seu concurso para uma preparação eficiente"
        }, {
          icon: <Award className="w-8 h-8 sm:w-10 sm:h-10 text-[#5f2ebe]" />,
