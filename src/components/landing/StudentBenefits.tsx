  ...
  return <div className="w-full px-4 py-16 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl text-[#022731] mb-3 sm:mb-4 font-extrabold">
            Por que estudar no <span className="text-[#2a8e9e]">BomEstudo</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {[{
          icon: <BookOpen className="w-8 h-8 sm:w-10 sm:h-10 text-[#2a8e9e]" />,
          ...
          icon: <FileText className="w-8 h-8 sm:w-10 sm:h-10 text-[#2a8e9e]" />,
          title: "Edital Verticalizado",
          description: "Organize seu estudo seguindo a estrutura do edital do seu concurso para uma preparação eficiente"
        }, {
          icon: <Award className="w-8 h-8 sm:w-10 sm:h-10 text-[#2a8e9e]" />,
          title: "Acompanhamento Contínuo",
          description: "Receba feedbacks e sugestões para melhorar seu desempenho e aumentar suas chances de aprovação"
        }].map((benefit, index) => <div key={index} className="bg-[#e8f1f3] p-4 sm:p-6 rounded-xl hover:shadow-md transition-shadow">
              <div className="flex flex-col h-full">
                <div className="p-2 sm:p-3 bg-white rounded-full w-fit shadow-sm mb-3 sm:mb-4">
                  {benefit.icon}
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-[#022731] mb-2 sm:mb-3">{benefit.title}</h3>
