...
export const Footer = () => {
  return <footer className="bg-[rgba(66,48,65,1)] w-full pt-[60px] px-2.5 mt-7">
      <div className="flex w-full items-center gap-[40px_120px] text-xl text-white pb-[50px] border-b border-[rgba(122,90,120,1)] flex-col md:flex-row">
        <img src="https://cdn.builder.io/api/v1/image/assets/d6eb265de0f74f23ac89a5fae3b90a0d/d4f7b31dd1bc48e16547963f6b0cd0adc76ffe16e180c12ccfce3d8a912308a0" alt="Footer Logo" className="w-[194px]" />
      ...
      <div className="flex w-full gap-[40px] text-xl text-white justify-between flex-wrap py-[50px] border-b border-[rgba(122,90,120,1)]">
        {["CONCURSOS", "DISCIPLINAS", "NOTÍCIAS", "LINKS ÚTEIS"].map((section, index) => <div key={index} className="flex flex-col w-full md:w-auto">
              <h2 className="font-bold mb-2.5">{section}</h2>
              {[1, 2, 3, 4, 5].map(item => <a key={item} href="#" className="mt-2.5 hover:text-gray-300">
                  Link {item}
                </a>)}
            </div>)}
      </div>
