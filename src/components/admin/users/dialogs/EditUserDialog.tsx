        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Input 
              id="nome" 
              value={usuario.nome} 
              onChange={(e) => onChangeUsuario({...usuario, nome: e.target.value})}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input 
              id="email" 
              value={usuario.email} 
              onChange={(e) => onChangeUsuario({...usuario, email: e.target.value})}
            />
          </div>
          <div className="space-y-2">
            ...
            <Select 
              ...
              onValueChange={(value: UserType) => 
                onChangeUsuario({...usuario, tipo: value})
              }
            >
              <SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Switch 
              ...
              onCheckedChange={(checked) => 
                onChangeUsuario({...usuario, status: checked ? 'ativo' : 'inativo'})
              }
            />
          ...
          <div className="flex items-center space-x-2">
            ...
            <Switch 
              id="assinante" 
              checked={usuario.assinante} 
              onCheckedChange={(checked) => 
                onChangeUsuario({...usuario, assinante: checked})
              }
            />
            <span className="text-sm text-[#67748a]">
            ...
            <>
              <div className="space-y-2">
                ...
                <Input 
                  id="inicioAssinatura" 
                  type="date"
                  value={usuario.inicioAssinatura} 
                  onChange={(e) => onChangeUsuario({...usuario, inicioAssinatura: e.target.value})}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  type="date"
                  value={usuario.terminoAssinatura} 
                  onChange={(e) => onChangeUsuario({...usuario, terminoAssinatura: e.target.value})}
                />
              </div>
            </>
          )}
