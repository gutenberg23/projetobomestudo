...
export const TopicsSection: React.FC<TopicsSectionProps> = ({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="border rounded-md p-3 border-[#5f2ebe]/30 max-h-[250px] overflow-y-auto">
        <table className="w-full">
          ...
          <tbody className="divide-y divide-[#5f2ebe]/10">
              ...
              <tr key={topic}>
                ...
                <td className="py-2">
                  <Input
                    ...
                    className="border-[#5f2ebe]/30 focus-visible:ring-[#5f2ebe] text-sm"
                  />
                </td>
              </tr>
            ))}
