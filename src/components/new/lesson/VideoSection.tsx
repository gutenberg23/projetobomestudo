    ...
    return (
      <div className="flex items-center gap-3">
        {teacher.socialMedia.youtube && (
          <a href={teacher.socialMedia.youtube} target="_blank" rel="noopener noreferrer" aria-label="Youtube">
            <Youtube className="w-5 h-5 text-[#ea2be2] hover:text-[#f11ce3]" />
          </a>
        )}
        {teacher.socialMedia.instagram && (
          <a href={teacher.socialMedia.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <Instagram className="w-5 h-5 text-[#ea2be2] hover:text-[#f11ce3]" />
          </a>
        )}
        {teacher.socialMedia.telegram && (
          <a href={teacher.socialMedia.telegram} target="_blank" rel="noopener noreferrer" aria-label="Telegram">
            <MessageCircle className="w-5 h-5 text-[#ea2be2] hover:text-[#f11ce3]" />
          </a>
        )}
        {teacher.socialMedia.facebook && (
          <a href={teacher.socialMedia.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <Facebook className="w-5 h-5 text-[#ea2be2] hover:text-[#f11ce3]" />
          </a>
        )}
        {teacher.socialMedia.twitter && (
          <a href={teacher.socialMedia.twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter">
    ...
    <div className="video-container w-full">
      ...
      <div className="flex justify-between items-center mb-3">
        <div className="flex items-center">
          <Avatar className="h-12 w-12 mr-3 border-2 border-[#ea2be2]">
