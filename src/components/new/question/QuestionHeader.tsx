...
export const QuestionHeader: React.FC<QuestionHeaderProps> = ({
  ...
  return (
    <header className="flex overflow-hidden flex-wrap justify-between items-center px-3 md:px-5 py-2.5 w-full rounded-t-xl rounded-b-none border border-[#f8fafc] border-solid bg-slate-50 min-h-[74px] text-slate-800">
