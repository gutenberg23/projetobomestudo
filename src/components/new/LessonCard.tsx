        ...
        <div className="flex justify-between px-5 w-full min-h-[70px]">
          <div className="flex flex-wrap flex-1 shrink justify-between items-center basis-0 min-w-60">
            <div className="flex items-center gap-4 flex-1">
              <div onClick={toggleLessonCompletion} className={`flex shrink-0 gap-2.5 self-stretch my-auto w-5 h-5 rounded border border-solid cursor-pointer ${isLessonCompleted ? "bg-fuchsia-500 border-fuchsia-500" : "bg-white border-gray-100"}`}>
                {isLessonCompleted && <svg viewBox="0 0 14 14" fill="white" className="w-4 h-4 m-auto">
              ...
              <div onClick={toggleVideoSection} className="flex flex-col flex-1 shrink justify-center self-stretch pr-5 my-auto basis-0 min-w-60 cursor-pointer py-0">
                <h2 className="font-bold leading-none text-slate-800 hover:text-[#F11CE3] transition-colors md:text-2xl text-lg">
                  {lesson.title}
                </h2>
                <p className="mt-0 md:mt-0 text-small leading-none text-slate-500 leading-none md:text-sm my-0 text-xs">
