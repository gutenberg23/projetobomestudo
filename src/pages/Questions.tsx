...
const MOCK_QUESTIONS = [
  {
    ...
    options: [
      { id: "o1", text: "O sistema tributário nacional é regido pelos princípios da legalidade, anterioridade e transparência fiscal." },
      { id: "o2", text: "A saúde é direito de todos e dever do Estado, garantido mediante políticas sociais e econômicas." },
      { id: "o3", text: "Os cargos, empregos e funções públicas são acessíveis aos brasileiros que preencham os requisitos estabelecidos em lei." },
      { id: "o4", text: "O ensino fundamental é obrigatório e gratuito, assegurada sua oferta para todos que não tiverem acesso na idade própria." },
      { id: "o5", text: "A previdência social será organizada sob a forma de regime geral, de caráter contributivo e de filiação obrigatória." }
    ],
    comments: [
      {
        id: "c1",
  ...
  },
  {
    ...
    options: [
      { id: "o6", text: "O princípio da legalidade significa que o administrador público está sujeito aos mandamentos da lei em toda sua atividade funcional." },
      { id: "o7", text: "A administração pública pode revogar seus próprios atos quando eivados de vícios que os tornem ilegais." },
      { id: "o8", text: "O princípio da impessoalidade estabelece que a finalidade pública deve nortear toda a atividade administrativa." },
      { id: "o9", text: "A presunção de legitimidade dos atos administrativos é absoluta, não admitindo prova em contrário." },
      { id: "o10", text: "O poder de polícia é indelegável, não podendo ser exercido por entidades da administração indireta." }
    ],
    comments: [
      {
        id: "c2",
