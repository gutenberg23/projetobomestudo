            ...
            <div>
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
                <div className="p-6 sm:p-8">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="mt-1 text-sm text-gray-600">
                            {concurso.estados.map((estado, index) => (
                              <span key={estado} className="mr-2 inline-block">
                  ...
                  {/* Link para o post com mais informações */}
                  {concurso.postId && (
                    <div className="mt-8 pt-6 border-t border-gray-200">
                      <div className="rounded-md bg-blue-50 p-4">
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            <h3 className="text-sm font-medium text-blue-800">Mais informações</h3>
                            <div className="mt-2 text-sm text-blue-700">
                              <p>
                                Acesse nosso artigo com informações detalhadas sobre este concurso:
                              </p>
                              <button
