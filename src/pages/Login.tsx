    ...
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="hidden md:block md:w-1/2 bg-[#272f3c] relative">
        ...
        <div className="w-full h-full flex items-center justify-center p-10">
          <img
            src="/lovable-uploads/90c45412-9b3b-40db-b562-ca8dc786ab82.png"
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 md:p-10 bg-white">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-4">
            ...
            {isLogin && (
              <div className="flex justify-between items-center">
                ...
                <Link
                  to="/esqueci-senha"
                  className="text-sm text-[#ea2be2] hover:underline"
                >
                  Esqueceu a senha?
                </Link>
              </div>
          ...
          <div className="text-center mt-6">
            ...
            <button
              className="text-[#ea2be2] hover:underline font-medium"
