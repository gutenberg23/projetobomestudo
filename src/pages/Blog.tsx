...
const Blog = () => {
  ...
  const mostCommentedPosts = [...MOCK_BLOG_POSTS]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <BlogList 
            posts={filteredPosts} 
            postsPerPage={6}
            title={searchTerm || activeRegion || activeState || activeCategory ? "Resultados da busca" : "Todos os artigos"}
          />
        </div>
        ...
        <div>
          ...
          <SidebarPosts
            ...
            icon={<Flame className="h-5 w-5 mr-2 text-[#ea2be2]" />}
          />
          ...
          <SidebarPosts
            ...
            icon={<MessageSquare className="h-5 w-5 mr-2 text-[#ea2be2]" />}
          />
          ...
          <Card className="mb-6">
            <CardHeader className="pb-2">
              <CardTitle className="flex items-center text-lg text-[#272f3c]">
                <Newspaper className="h-5 w-5 mr-2 text-[#ea2be2]" />
                Últimas notícias
              </CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
