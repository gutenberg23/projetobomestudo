...
export const AdicionarDisciplina: React.FC<AulasPageProps> = ({
  ...
  return <div className="flex justify-end mt-4 items-center gap-3">
      {temAulasSelecionadas && <div className="flex-1 max-w-md">
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input id="titulo-disciplina" placeholder="Digite o título da disciplina" value={tituloNovaDisciplina} onChange={e => setTituloNovaDisciplina(e.target.value)} className="border-[#ea2be2] focus-visible:ring-[#ea2be2]" />
            </div>
            <div>
      ...
      {temAulasSelecionadas && <Button onClick={handleAdicionarDisciplina} className="bg-[#ea2be2] hover:bg-[#ea2be2]/90 w-auto" disabled={!tituloNovaDisciplina.trim()}>
